...
class ExampleLottieMarkers extends StatefulWidget {
  const ExampleLottieMarkers({Key? key}) : super(key: key);

  @override
  _ExampleLottieMarkersState createState() => _ExampleLottieMarkersState();
}

class _ExampleLottieMarkersState extends State<ExampleLottieMarkers>
