...
class ExampleLottieSaveFrames extends StatefulWidget {
  const ExampleLottieSaveFrames({Key? key}) : super(key: key);

  @override
  _ExampleLottieSaveFramesState createState() =>
      _ExampleLottieSaveFramesState();
}

class _ExampleLottieSaveFramesState extends State<ExampleLottieSaveFrames> {
  List<File>? _frames;
