...
class ExampleLottieDynamicProperties extends StatefulWidget {
  const ExampleLottieDynamicProperties({Key? key}) : super(key: key);

  @override
  _ExampleLottieDynamicPropertiesState createState() =>
      _ExampleLottieDynamicPropertiesState();
}

class _ExampleLottieDynamicPropertiesState
    extends State<ExampleLottieDynamicProperties>
