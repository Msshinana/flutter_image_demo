...
class ExampleLottieFullControl extends StatefulWidget {
  const ExampleLottieFullControl({Key? key}) : super(key: key);

  @override
  _ExampleLottieFullControlState createState() =>
      _ExampleLottieFullControlState();
}

class _ExampleLottieFullControlState extends State<ExampleLottieFullControl>
